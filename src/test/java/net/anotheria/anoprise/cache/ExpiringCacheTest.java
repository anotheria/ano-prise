...
public class ExpiringCacheTest {
	@Test public void testBasicFunctionality() throws Exception{
		ExpiringCache<Integer, String> cache = new ExpiringCache<>(10000, new RoundRobinHardwiredCache<Integer, CachedObjectWrapper<String>>(START_SIZE, MAX_SIZE));
	...
	@Test public void testFailover() throws Exception{
		ExpiringCache<Integer, String> underlyingCache = new ExpiringCache<>(10000, new RoundRobinHardwiredCache<Integer, CachedObjectWrapper<String>>(START_SIZE, MAX_SIZE));
		Cache<Integer, String> cache = new FailoverCache<>(INSTANCE_AMOUNT, CURRENT_INSTANCE_NUMBER, null, underlyingCache);
